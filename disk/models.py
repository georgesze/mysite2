...
class AliOrd(models.Model):
    ...
    UplineId = models.CharField(max_length = 20, verbose_name='上线ID', blank=True)
    UplineName = models.CharField(max_length = 20, verbose_name='上线名称', blank=True)
    Up2lineId = models.CharField(max_length = 20, verbose_name='上上线ID', blank=True)
    Up2lineName = models.CharField(max_length = 20, verbose_name='上上线名称', blank=True)
